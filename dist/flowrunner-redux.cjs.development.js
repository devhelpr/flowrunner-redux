...
var FlowRunner = require('@devhelpr/flowrunner');
...
var flowEventRunner = /*#__PURE__*/new FlowRunner.FlowEventRunner();
...
var subjectStoreChange = /*#__PURE__*/new rxjs.Subject();
...
var startFlow = function startFlow(flowPackage, appReducers, options) {
  ...
  return flowEventRunner.start(flowPackage, services, true).then(function (services) {
    var rootReducer = Redux.combineReducers(Object.assign({}, reducers, appReducers));
    ...
    if ( typeof window !== 'undefined' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ !== undefined) {
      ...
      if (options.reduxMiddleware) {
        enhancer = composeEnhancers(Redux.applyMiddleware(thunk, flowNotifierFactory(), options.reduxMiddleware));
      } else {
        enhancer = composeEnhancers(Redux.applyMiddleware(thunk, flowNotifierFactory()));
      }

      store = Redux.createStore(rootReducer, options.initialStoreState, enhancer);
    } else {
      if (options.reduxMiddleware) {
        store = Redux.createStore(rootReducer, options.initialStoreState, Redux.applyMiddleware(thunk, flowNotifierFactory(), options.reduxMiddleware));
      } else {
        store = Redux.createStore(rootReducer, options.initialStoreState, Redux.applyMiddleware(thunk, flowNotifierFactory()));
      }
...
var ReactComponentFlowConnector = function ReactComponentFlowConnector(Component) {
  return /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      var getComponent = function getComponent() {
        return React.createElement(Component, Object.assign({}, _this3.props, {
...
var ReactComponentTriggerFlow = function ReactComponentTriggerFlow(Component) {
  return /*#__PURE__*/function (_React$Component) {
    _inheritsLoose(_class, _React$Component);
...
exports.ReactComponentFlowConnector = ReactComponentFlowConnector;
exports.ReactComponentTriggerFlow = ReactComponentTriggerFlow;
exports.ReduxActionTask = ReduxActionTask;
exports.ReduxArrayStateType = ReduxArrayStateType;
exports.ReduxAssignArrayActionTask = ReduxAssignArrayActionTask;
exports.ReduxClearArrayActionTask = ReduxClearArrayActionTask;
exports.ReduxGetKeyTask = ReduxGetKeyTask;
exports.ReduxGetTask = ReduxGetTask;
exports.ReduxHashmapStateType = ReduxHashmapStateType;
exports.ReduxPropertyStateType = ReduxPropertyStateType;
exports.ReduxPushArrayActionTask = ReduxPushArrayActionTask;
exports.ReduxSetItemByKeyArrayActionTask = ReduxSetItemByKeyArrayActionTask;
exports.ReduxSetKeyActionTask = ReduxSetKeyActionTask;
exports.ReduxThunkActionTask = ReduxThunkActionTask;
exports.StoreObserverTask = StoreObserverTask;
exports.flowAction = flowAction;
exports.getFlowEventRunner = getFlowEventRunner;
exports.startFlow = startFlow;
//# sourceMappingURL=flowrunner-redux.cjs.development.js.map
